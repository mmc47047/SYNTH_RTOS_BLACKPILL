...
<table>
  ...
  저는 <b>TFT LCD 기반 UI 구현</b>과 <b>입력–UI 연동 로직</b>, 
  <b>RTOS 환경에서의 UI Task 설계</b>를 담당했습니다.
      </p>
      <ul>
...
> 파라미터 변경 시 TFT LCD의 그래프 및 수치가 즉시 갱신되도록 UI를 구현했습니다.
...
- I2S DAC: 스피커/이어폰 출력
- TFT-LCD UI는 RTOS 기반 LCD Task로 분리하여 오디오 처리와 독립적으로 동작
---
...
- RTOS 환경에서 UI Task를 분리하고, 부분 갱신 구조를 적용하여 실시간 시스템의 안정성을 확보
